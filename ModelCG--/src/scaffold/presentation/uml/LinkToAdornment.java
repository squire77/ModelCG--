...
import scaffold.platform.graphics.graph.Adornment;
...
public class LinkToAdornment extends Adornment {
    public static final int TOP=0, BOTTOM=1, RIGHT=2, LEFT=3;
      
    public LinkToAdornment(UMLCanvas canvas, UMLClassNode node, int location) {
    ...
    //rtype : 0-IMPLEMENT INTERFACE, 1-INHERIT FROM SUPER CLASS, 2-AGGREGATION,
    ...
    private void linkToNewClass(int rtype, int posX, int posY) {
        ...
        if (rtype == 0) {
            ...
            umlCanvas.addUMLInheritanceLink(e1, e2, e1Location, e2Location, percent);
        }
