package scaffold.application.console;

import scaffold.application.codegen.CmGenerator;
import scaffold.application.console.docviewer.ModelDocumentViewer;
import scaffold.application.console.docviewer.TemplateViewer;
import scaffold.modeling.uml.ClassModel;
import scaffold.platform.docmanager.ITitleIndicator;
import scaffold.platform.docmanager.DocumentManager;
import scaffold.platform.docmanager.IDocumentManager;
import scaffold.platform.ErrorDialog;
import scaffold.platform.docviewer.DocumentViewer;
...
public class Console extends JFrame implements ITitleIndicator {
    ...
    private JMenuBar createMenuBar() {
        ...
        clicheHelp.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) {
                startViewer.openFile("data/help/cliche_help.txt");
            }
        } );
        classHelp.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) {
                startViewer.openFile("data/help/class_help.txt");
            }
        } );
        projectHelp.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) {
                startViewer.openFile("data/help/project_help.txt");
            }
        } );
